...
#define OSSL_ASYM_CIPHER_PARAM_FIPS_APPROVED_INDICATOR                         \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
#define OSSL_ASYM_CIPHER_PARAM_FIPS_KEY_CHECK OSSL_PKEY_PARAM_FIPS_KEY_CHECK
#define OSSL_ASYM_CIPHER_PARAM_FIPS_RSA_PKCS15_PAD_DISABLED                    \
...
#define OSSL_CIPHER_PARAM_FIPS_APPROVED_INDICATOR                              \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define OSSL_DRBG_PARAM_FIPS_APPROVED_INDICATOR                                \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define OSSL_EXCHANGE_PARAM_FIPS_APPROVED_INDICATOR                            \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
#define OSSL_EXCHANGE_PARAM_FIPS_DIGEST_CHECK OSSL_PKEY_PARAM_FIPS_DIGEST_CHECK
#define OSSL_EXCHANGE_PARAM_FIPS_ECDH_COFACTOR_CHECK                           \
...
#define OSSL_KDF_PARAM_FIPS_APPROVED_INDICATOR                                 \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define OSSL_KEM_PARAM_FIPS_APPROVED_INDICATOR                                 \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define OSSL_MAC_PARAM_FIPS_APPROVED_INDICATOR                                 \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define OSSL_PKEY_PARAM_FIPS_APPROVED_INDICATOR                                \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define OSSL_RAND_PARAM_FIPS_APPROVED_INDICATOR                                \
  OSSL_ALG_PARAM_FIPS_APPROVED_INDICATOR
