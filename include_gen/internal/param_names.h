...
#define PIDX_ASYM_CIPHER_PARAM_FIPS_APPROVED_INDICATOR                         \
  PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define PIDX_ASYM_CIPHER_PARAM_FIPS_RSA_PKCS15_PAD_DISABLED                    \
  PIDX_PROV_PARAM_RSA_PKCS15_PAD_DISABLED
...
#define PIDX_CIPHER_PARAM_FIPS_APPROVED_INDICATOR                              \
  PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define PIDX_EXCHANGE_PARAM_FIPS_ECDH_COFACTOR_CHECK                           \
  PIDX_PROV_PARAM_ECDH_COFACTOR_CHECK
...
#define PIDX_KDF_PARAM_FIPS_APPROVED_INDICATOR                                 \
  PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define PIDX_KEM_PARAM_FIPS_APPROVED_INDICATOR                                 \
  PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define PIDX_MAC_PARAM_FIPS_APPROVED_INDICATOR                                 \
  PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define PIDX_PKEY_PARAM_FIPS_APPROVED_INDICATOR                                \
  PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define PIDX_RAND_PARAM_FIPS_APPROVED_INDICATOR                                \
  PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
...
#define PIDX_SIGNATURE_PARAM_ALGORITHM_ID_PARAMS                               \
  PIDX_PKEY_PARAM_ALGORITHM_ID_PARAMS
...
#define PIDX_SIGNATURE_PARAM_FIPS_APPROVED_INDICATOR                           \
  PIDX_ALG_PARAM_FIPS_APPROVED_INDICATOR
